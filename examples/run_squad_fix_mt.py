...
from pytorch_pretrained_bert.modeling_mt_drop import BertForQuestionAnswering_count, BertConfig           ## changed module name
...
def main():
    ...
    # Prepare model
    model = BertForQuestionAnswering_count.from_pretrained(args.bert_model, max_seq_length=args.max_seq_length,         ## change name and add max_seq_length
