...
def main(args: argparse.Namespace):
    ...
    image = f"allennlp/bert-drop:{commit}"
    ...
    program_run_command = [
            ...
            "--do_validate",
            "--do_predict",
            "--train_file", "/dd_squad/dd_squad_train.json",
            "--validate_file", "/dd_squad/dd_squad_dev.json",
            "--predict_file", "/dd_squad/dd_squad_test.json",
            "--train_batch_size", "24",
            "--learning_rate", "3e-5",
    ...
    #     "--do_validate",
    #     "--do_predict",
    #     "--train_file", "/dataset_split_latest/drop_dataset_squad_train.json",
    #     "--validate_file", "/dataset_split_latest/drop_dataset_squad_dev.json",
    #     "--predict_file", "/dataset_split_latest/drop_dataset_squad_dev.json",
    #     "--train_batch_size", "12",
    #     "--learning_rate", "3e-5",
    #     "--num_train_epochs", "5.0",
    #     "--max_seq_length", "384",
    ...
    dataset_mounts = []
    dd_squad_dataset_id = "anonymous_id"
    for source in args.source + [f"{dd_squad_dataset_id}:/dd_squad"]:
